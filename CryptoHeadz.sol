...
contract CryptoHeadz is ERC20, Ownable {
    ...
    address public marketingWallet = 0x2b7E7f24BD026790c28b48D67F4cC6a54127e8d4;
    address public devWallet = 0x0f30c2FeEF1124b3E212520C7593E1fa6AC052c7;
    ...
    constructor() ERC20("CryptoHeadz", "HEADZ") {
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "HEADZ: Automated market maker pair is already set to that value");
...
contract HEADZDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("HEADZ_Dividen_Tracker", "HEADZ_Dividend_Tracker") {
    	claimWait = 3600;
